...
namespace Balaso
{
    ...
    {
        private static string SETTINGS_ASSET_PATH = "Assets/_DT1_AdsPlugin/External Assets/Balaso Software/Editor/Settings.asset";
        ...
        private static void CreateLocalizationDictionary()
        {
                ...
                (settings.LocalizedPopupMessageDictionary == null || settings.LocalizedPopupMessageDictionary.Count == 0))
            {
                ...
                settings.LocalizedPopupMessageDictionary.Add((int)SystemLanguage.ChineseSimplified, "点击'允许'以使用设备信息获得更加相关的广告内容");
                settings.LocalizedPopupMessageDictionary.Add((int)SystemLanguage.ChineseTraditional, "点击'允许'以使用设备信息获得更加相关的广告内容");
