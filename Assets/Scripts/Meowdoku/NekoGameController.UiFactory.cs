...
namespace Meowdoku
{
    public sealed partial class NekoGameController
    {
        ...
        private Text CreateText(RectTransform parent, string value, int fontSize, FontStyle style, TextAnchor alignment, Color color)
        {
        ...
        private void CreateButton(RectTransform parent, string label, UnityEngine.Events.UnityAction action)
        {
            ...
            Text text = CreateText((RectTransform)buttonObject.transform, label, label.Length > 5 ? 26 : 34, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white);
