...
namespace Meowdoku
{
    public sealed class NekoLevel
    {
        ...
        public NekoLevel(string title, string targetWord, int[] regions, NekoCoord[] solution, NekoCoord[] lockedCats, int difficultyTier = 1)
        {
            ...
            DifficultyTier = Math.Max(1, difficultyTier);
