...
namespace Meowdoku
{
    public sealed partial class NekoGameController
    {
        ...
        {
            GameObject cellObject = Instantiate(cellPrefab, parent, false);
            ...
            view.NekoImage.sprite = nekoCatSprite;
        ...
        private void RefreshBoard()
        {
            ...
            countText.text = $"Found {validation.RevealedCatCount}/{board.Size}   Hearts {HeartLabel(validation.HeartsRemaining)}";
