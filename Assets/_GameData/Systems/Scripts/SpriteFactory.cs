...
{
    /// <summary>
    /// Procedurally draws the cat face, focus ring, and juice-dot sprites at
    /// startup (triangle-fill/Bresenham pixel art, no source images). Kept as a
    /// runtime generator rather than baked assets deliberately - low risk, purely
    /// cosmetic; revisit only if boot-time cost or art direction changes.
    /// </summary>
    public static class SpriteFactory
    {
        private static readonly Color FocusRingColor = new Color(0.08f, 0.35f, 0.33f, 1f);

        public static Sprite LoadTutorialHandSprite(Texture2D tutorialHandTexture)
        {
        ...
        public static Sprite CreateFocusRingSprite()
        {
        ...
        public static Sprite CreateJuiceDotSprite()
        {
        ...
        public static Sprite CreateNekoCatSprite()
        {
            const int textureSize = 128;
            Color32[] pixels = new Color32[textureSize * textureSize];
            Color32 clear = new Color32(0, 0, 0, 0);
