...
namespace Meowdoku
{
    ...
    public sealed class BoardView : MonoBehaviour
    {
        ...
        public Vector2 BoardRestPosition => boardRestPosition;

        public bool Validate()
        {
            bool valid = true;
            valid &= SceneValidation.LogIfMissing(cellPrefab, "Cell Prefab", this);
            valid &= SceneValidation.LogIfMissing(boardRoot, "Board Root", this);
            return valid;
        }

        public void SetCatSprite(Sprite sprite)
        {
            catSprite = sprite;
        }
        ...
        private CellUi CreateCell(PuzzleBoard board, BoardInputHandler inputHandler, int row, int column)
        {
            ...
            UiFactory.SetRect(rect, new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), Vector2.zero, Vector2.zero);
            ...
            view.NekoImage.sprite = catSprite;
        ...
        private IEnumerator AnimateIntro(PuzzleBoard board, bool inputLocked)
        {
            ...
            while (elapsed < totalSeconds)
            {
                ...
                for (int i = 0; i < states.Length; i++)
                {
                    ...
                    float easedScale = NekoEasing.OutBack(t);
        ...
        public bool TryGetCellUi(int row, int column, out CellUi cellUi)
        {
            if (cellGrid != null
                && row >= 0
                && column >= 0
        ...
        /// <summary>Cancels any in-progress punch on this cell and hands its Rect/Outline to a caller that wants to animate the cat-found pop.</summary>
        public bool TryBeginCatFoundPop(Coord coord, out RectTransform rect, out Outline outline)
        {
